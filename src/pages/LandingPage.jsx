            ...
            <header className="fixed top-0 w-full z-50 bg-surface/80 glass-nav shadow-sm transition-all duration-300">
                <div className="max-w-7xl mx-auto px-container-margin flex justify-between items-center h-20">
                    ...
                    <div className="flex items-center gap-sm">
                        ...
                        <a href="https://wa.me/5511922928343?text=Ol%C3%A1%2C%20gostaria%20de%20come%C3%A7ar%20a%20usar%20o%20OperaBeauty!" target="_blank" rel="noopener noreferrer" className="bg-primary text-on-primary font-label-md text-label-md px-lg py-sm rounded-full hover:opacity-80 transition-opacity inline-block">Começar</a>
                    </div>
                </div>
            </header>
            <main className="pt-20">
                ...
                <section className="relative overflow-hidden bg-background py-xl md:py-32">
                    <div className="max-w-7xl mx-auto px-container-margin grid grid-cols-1 md:grid-cols-2 gap-xl items-center">
                        <div className="space-y-lg z-10">
                            <span className="inline-block px-md py-xs bg-primary-container text-on-primary-container rounded-full text-label-sm font-semibold tracking-wider">SOLUÇÃO SAAS PREMIUM</span>
                            <h1 className="font-display-lg text-display-lg text-on-surface">Transforme a gestão do seu salão com elegância</h1>
                            <p className="font-body-lg text-body-lg text-secondary w-full md:max-w-[90%]">OperaBeauty combina inteligência operacional com uma interface serena, permitindo que você foque no que realmente importa: a experiência dos seus clientes.</p>
                            <div className="flex flex-wrap gap-md pt-md">
                                <a href="https://wa.me/5511922928343?text=Ol%C3%A1%2C%20gostaria%20de%20come%C3%A7ar%20a%20usar%20o%20OperaBeauty!" target="_blank" rel="noopener noreferrer" className="bg-primary text-on-primary px-lg py-md rounded-xl font-label-md text-label-md premium-shadow hover:-translate-y-1 transition-all duration-300 inline-block">Começar Agora</a>
                            </div>
                        </div>
                            ...
                            {plans.map((plan, index) => {
                                ...
                                return (
                                    <div key={plan.id} className={isFeatured
                                        ...
                                        <button className={`w-full py-md rounded-xl font-label-md transition-colors ${isFeatured
                ...
                <section className="py-32 bg-primary-container/20">
                    <div className="max-w-4xl mx-auto px-container-margin text-center space-y-lg">
                        ...
                        <div className="pt-md">
                            <a href="https://wa.me/5511922928343?text=Ol%C3%A1%2C%20gostaria%20de%20iniciar%20meu%20teste%20gr%C3%A1tis%20do%20OperaBeauty!" target="_blank" rel="noopener noreferrer" className="bg-primary text-on-primary px-xl py-lg rounded-2xl font-label-md text-body-lg premium-shadow-lg hover:-translate-y-1 transition-all duration-300 inline-block">Começar Teste Grátis de 14 dias</a>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-container-margin grid grid-cols-1 md:grid-cols-4 gap-lg">
                    ...
                    <div>
                        ...
                        <ul className="space-y-sm">
                            <li><a className="font-body-md text-body-md text-on-secondary-container hover:text-primary transition-colors" href="#">Recursos</a></li>
                            <li><a className="font-body-md text-body-md text-on-secondary-container hover:text-primary transition-colors" href="#">Planos</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-sm">
                            <li><a className="font-body-md text-body-md text-on-secondary-container hover:text-primary transition-colors" href="#">Central de Ajuda</a></li>
                            <li><a className="font-body-md text-body-md text-on-secondary-container hover:text-primary transition-colors" href="#">Política de Privacidade</a></li>
                            <li><a className="font-body-md text-body-md text-on-secondary-container hover:text-primary transition-colors" href="#">Termos de Serviço</a></li>
                        </ul>
                    </div>
                </div>
